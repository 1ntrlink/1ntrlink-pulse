...
# This will run your Pulse script and return data
...
app.layout = html.Div(style={
    ...
    dcc.Interval(id="interval", interval=45*1000, n_intervals=0),  # Update every 45s
...
def update_chart(n):
    ...
    stats_divs = [
        ...
        html.Div([html.Strong("Max DD"), html.Br(), f"{stats['max_dd']:.1f}%"], style={"color": "#FF4444" if stats['max_dd'] < -8 else "#AAA"}),
    ]
